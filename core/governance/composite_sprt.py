...
from observability.codes import SPRT_DECISION_H0, SPRT_DECISION_H1, SPRT_CONTINUE, SPRT_ERROR
...
class SPRTResult:
    ...
    decision: Optional[str]  # 'accept_h1', 'accept_h0', 'continue'
...
class HypothesisModel(ABC):
    ...
    @abstractmethod
    def sufficient_statistics(self, observations: np.ndarray) -> Dict[str, Union[float, int]]:
...
class AlphaSpendingLedger:
    ...
    def can_spend_alpha(self, requested_alpha: float, test_idx: Optional[int] = None) -> bool:
    ...
    def spend_alpha(self, entry: AlphaSpendingEntry, test_idx: Optional[int] = None) -> bool:
...
class CompositeSPRT:
    ...
    def __init__(self, 
                 alpha: float = 0.05, 
                 beta: float = 0.20,
                 alpha_ledger: Optional[AlphaSpendingLedger] = None,
        ...
        self.model_h0: Optional[HypothesisModel] = None
        self.model_h1: Optional[HypothesisModel] = None
    ...
    def update(self, 
               observation: float,
               model_h0: Union[HypothesisModel, CompositeHypothesis],
               model_h1: Union[HypothesisModel, CompositeHypothesis],
               weight: float = 1.0,
               test_id: str = "default",
    ...
    def _log_sprt_decision(self, decision: Optional[str], result: SPRTResult, 
