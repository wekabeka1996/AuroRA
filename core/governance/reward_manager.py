...
class Decision:
    ...
    trail_reward: Optional[float] = None  # New field for reward tracking
...
class RewardManager:
    ...
    def close_trail(self, decision_id: str, final_reward: float = None) -> Optional[RewardTrail]:
    ...
    def get_trail_summary(self, decision_id: str) -> Optional[Dict[str, Any]]:
