    ...
    def _load_config(self) -> dict:
        ...
        try:
            ...
            return {
                ...
                'taker_escalation_ttl_ms': cfg.get("execution.router.taker_escalation_ttl_ms", 1000),
                't_min_requote_ms': cfg.get("execution.router.t_min_requote_ms", 150),
                'max_requotes_per_min': cfg.get("execution.router.max_requotes_per_min", 20),
                ...
                'vol_spike_atr_mult': cfg.get("execution.router.vol_spike_guard.atr_mult", 2.0),
                'vol_spike_window_s': cfg.get("execution.router.vol_spike_guard.window_s", 300),
            }
        except (ConfigError, Exception):
