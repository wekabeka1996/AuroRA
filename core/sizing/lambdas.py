...
@dataclass
class LambdaPolicy:
    cal: LambdaCalConfig = field(default_factory=LambdaCalConfig)
    reg: LambdaRegConfig = field(default_factory=LambdaRegConfig)
    liq: LambdaLiqConfig = field(default_factory=LambdaLiqConfig)
    dd: LambdaDDConfig = field(default_factory=LambdaDDConfig)
    lat: LambdaLatConfig = field(default_factory=LambdaLatConfig)
