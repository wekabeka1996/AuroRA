...
class MockExchange:
    ...
    async def submit_order(self, order: OrderRequest) -> Dict[str, Any]:
        ...
        return {"status": "accepted", "order_id": order_id, "timestamp": time.time()}
    ...
    async def cancel_order(self, order_id: str) -> Dict[str, Any]:
        ...
        return {"status": "cancelled", "order_id": order_id, "timestamp": time.time()}
...
class MockExchangeFactory:
    ...
    @staticmethod
    def create_deterministic_exchange(
        fill_profile: Optional[Dict[str, Any]] = None
    ) -> MockExchange:
    ...
    @staticmethod
    def create_stochastic_exchange(
        fill_profile: Optional[Dict[str, Any]] = None
    ) -> MockExchange:
    ...
    @staticmethod
    def create_partial_fill_exchange(
        fill_profile: Optional[Dict[str, Any]] = None
    ) -> MockExchange:
    ...
    @staticmethod
    def create_rejecting_exchange(
        reject_rate: float = 0.1, fill_profile: Optional[Dict[str, Any]] = None
    ) -> MockExchange:
    ...
    @staticmethod
    def create_high_latency_exchange(
        fill_profile: Optional[Dict[str, Any]] = None
    ) -> MockExchange:
    ...
    @staticmethod
    def create_exchange_with_price_sequence(
        price_sequence: List[float], fill_profile: Optional[Dict[str, Any]] = None
    ) -> MockExchange:
