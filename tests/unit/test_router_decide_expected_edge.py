...
def test_high_pfill_tight_spread_maker():
    ...
    d = r.decide("buy", q, edge_bps_estimate=5.0, latency_ms=10.0, 
...
def test_low_pfill_wide_spread_taker():
    ...
    d = r.decide("buy", q, edge_bps_estimate=2.0, latency_ms=10.0, 
...
def test_sla_denies_on_high_latency():
    ...
    r = make_router()
    q = type("Q", (), {"bid_px": 49999.0, "ask_px": 50001.0})
    d = r.decide("buy", q, edge_bps_estimate=5.0, latency_ms=300.0, 
...
def test_edge_floor_after_latency():
    ...
    d = r.decide("buy", q, edge_bps_estimate=0.5, latency_ms=100.0, 
...
def test_why_unattractive_on_very_wide_spread():
    ...
    r = make_router()
    q = type("Q", (), {"bid_px": 49999.0, "ask_px": 50001.0})
    d = r.decide("buy", q, edge_bps_estimate=3.0, latency_ms=10.0, 
...
def test_scores_present_for_xai():
    ...
    assert d.why_code in ["OK_ROUTE_MAKER", "OK_ROUTE_TAKER", "WHY_UNATTRACTIVE", "WHY_SLA_LATENCY"]