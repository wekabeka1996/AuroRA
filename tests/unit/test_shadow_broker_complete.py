...
from core.execution.shadow_broker import ShadowBroker, BinanceFilters, OrderReject
...
class TestShadowBrokerComplete:
    ...
    def test_validate_order_valid(self, mock_load_cfg):
        ...
        with patch('requests.get') as mock_get:
            ...
            # Валідний ордер
            result = broker._validate_order("BTCUSDT", "BUY", "LIMIT", Decimal("0.001"), Decimal("50000.0"))
    ...
    def test_validate_order_invalid_quantity(self, mock_load_cfg):
        ...
        with patch('requests.get') as mock_get:
            ...
            result = broker._validate_order("BTCUSDT", "BUY", "LIMIT", Decimal("0.0001"), Decimal("50000.0"))
    ...
    def test_validate_order_invalid_price(self, mock_load_cfg):
        ...
        with patch('requests.get') as mock_get:
            ...
            # Занадто низька ціна
            result = broker._validate_order("BTCUSDT", "BUY", "LIMIT", Decimal("0.001"), Decimal("0.001"))
            assert result is not None
    ...
    def test_validate_order_invalid_notional(self, mock_load_cfg):
        ...
        with patch('requests.get') as mock_get:
            ...
            mock_response.json.return_value = {
                "symbols": [{
                    ...
                    "filters": [
                        {"filterType": "LOT_SIZE", "minQty": "0.001", "maxQty": "100.0", "stepSize": "0.001"},
                        {"filterType": "PRICE_FILTER", "minPrice": "0.01", "maxPrice": "100000.0", "tickSize": "0.01"},
                        {"filterType": "MIN_NOTIONAL", "minNotional": "1000.0"}  # Високий min notional
                    ]
                }]
            }
            mock_response.raise_for_status.return_value = None
            ...
            result = broker._validate_order("BTCUSDT", "BUY", "LIMIT", Decimal("0.001"), Decimal("1.0"))
            assert result is not None
    ...
    def test_validate_order_unknown_symbol(self, mock_load_cfg):
        ...
        with patch('requests.get') as mock_get:
            ...
            # Невідомий символ
            result = broker._validate_order("UNKNOWN", "BUY", "LIMIT", Decimal("0.001"), Decimal("50000.0"))
            assert result is not None
    ...
    def test_simulate_fill_market_order(self, mock_load_cfg):
        ...
        with patch('requests.get') as mock_get:
            ...
            with patch('time.time', return_value=1234567890.123):
                result = broker._simulate_fill("BTCUSDT", "BUY", "MARKET", Decimal("0.001"))
    ...
    def test_simulate_fill_limit_order(self, mock_load_cfg):
        ...
        with patch('requests.get') as mock_get:
            ...
            with patch('time.time', return_value=1234567890.123):
                result = broker._simulate_fill("BTCUSDT", "SELL", "LIMIT", Decimal("0.001"), Decimal("50000.0"))
        ...
        with patch('requests.get') as mock_get:
            ...
            with patch('time.time', return_value=1234567890.123):
                with patch('builtins.open', create=True) as mock_open:
                    ...
                    broker._log_order_event("FILLED", "BTCUSDT", "BUY", "MARKET", Decimal("0.001"), Decimal("50000.0"), "SUCCESS")
    ...
    def test_submit_order_limit_success(self, mock_load_cfg):
        ...
        with patch('requests.get') as mock_get:
            ...
            with patch('time.time', return_value=1234567890.123):
                with patch('builtins.open', create=True):
                    result = broker.submit_order("BTCUSDT", "SELL", "LIMIT", 0.001, 50000.0)
    ...
    def test_submit_order_rejection(self, mock_load_cfg):
        ...
        with patch('requests.get') as mock_get:
            ...
            with patch('time.time', return_value=1234567890.123):
                with patch('builtins.open', create=True):
                    result = broker.submit_order("BTCUSDT", "BUY", "LIMIT", 0.001, 1.0)  # Занадто малий notional
        ...
        with patch('requests.get') as mock_get:
            ...
            with patch('time.time', return_value=1234567890.123):
                with patch('builtins.open', create=True):
                    ...
                    result = broker.submit_order("BTCUSDT", "BUY", "LIMIT", 2.0, 50000.0, "IOC")
        ...
        with patch('requests.get') as mock_get:
            ...
            with patch('time.time', return_value=1234567890.123):
                with patch('builtins.open', create=True):
                    ...
                    result = broker.submit_order("BTCUSDT", "BUY", "LIMIT", 20.0, 50000.0, "FOK")
    ...
    def test_validate_and_round_order(self, mock_load_cfg):
        ...
        with patch('requests.get') as mock_get:
            ...
            # Валідний ордер
            is_valid, message, qty, price = broker.validate_and_round_order("BTCUSDT", "BUY", "LIMIT", 0.001234, 50000.123)
            ...
            # Невалідний ордер
            is_valid, message, qty, price = broker.validate_and_round_order("BTCUSDT", "BUY", "LIMIT", 0.0001, 50000.0)
    ...
    def test_edge_case_min_values(self, mock_load_cfg):
        ...
        with patch('requests.get') as mock_get:
            ...
            result = broker._validate_order("BTCUSDT", "BUY", "LIMIT", Decimal("0.001"), Decimal("10000.0"))
    ...
    def test_edge_case_max_values(self, mock_load_cfg):
        ...
        with patch('requests.get') as mock_get:
            ...
            result = broker._validate_order("BTCUSDT", "BUY", "LIMIT", Decimal("100.0"), Decimal("10000.0"))
            assert result is None

            # Максимальна ціна
            result = broker._validate_order("BTCUSDT", "BUY", "LIMIT", Decimal("0.001"), Decimal("100000.0"))
            assert result is None
                ...
                "symbols": [
                    ...
                    },
                    {
                        ...
                        "filters": [
                            ...
                            {"filterType": "PRICE_FILTER", "minPrice": "0.1", "maxPrice": "10000.0", "tickSize": "0.1"},
                            {"filterType": "MIN_NOTIONAL", "minNotional": "10.0"}
                        ]
                    }
                ]
    ...
    def test_validate_order_max_quantity(self, mock_load_cfg):
        ...
        with patch('requests.get') as mock_get:
            ...
            result = broker._validate_order("BTCUSDT", "BUY", "LIMIT", Decimal("200.0"), Decimal("50000.0"))
            assert result is not None
            assert result.reason == "LOT_SIZE"
    ...
    def test_validate_order_price_tick_size(self, mock_load_cfg):
        ...
        with patch('requests.get') as mock_get:
            ...
            result = broker._validate_order("BTCUSDT", "BUY", "LIMIT", Decimal("0.001"), Decimal("0.015"))
            assert result is not None
            assert result.reason == "PRICE_FILTER"
    ...
    def test_validate_order_quantity_step_size(self, mock_load_cfg):
        ...
        with patch('requests.get') as mock_get:
            ...
            result = broker._validate_order("BTCUSDT", "BUY", "LIMIT", Decimal("0.0015"), Decimal("50000.0"))
            assert result is not None
            assert result.reason == "LOT_SIZE"
    ...
    def test_validate_and_round_order_invalid(self, mock_load_cfg):
        ...
        with patch('requests.get') as mock_get:
            ...
            result = broker.validate_and_round_order("BTCUSDT", "BUY", "LIMIT", Decimal("0.0001"), Decimal("50000.0"))
    ...
    def test_validate_order_price_max(self, mock_load_cfg):
        ...
        with patch('requests.get') as mock_get:
            ...
            result = broker._validate_order("BTCUSDT", "BUY", "LIMIT", Decimal("0.001"), Decimal("200000.0"))
            assert result is not None
            assert result.reason == "PRICE_FILTER"
    ...
    def test_simulate_fill_sell_market(self, mock_load_cfg):
        ...
        with patch('requests.get') as mock_get:
            ...
            with patch('time.time', return_value=1234567890.123):
                result = broker._simulate_fill("BTCUSDT", "SELL", "MARKET", Decimal("0.001"))
                ...
                expected_price = Decimal("50000") * (1 - Decimal(broker.slippage_bps) / Decimal(10000))
